...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2021 at 03:58 AM
...
--
-- Table structure for table `deliver_choice`
--

CREATE TABLE `deliver_choice` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `deliver_choice_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `deliver_choice`
--

INSERT INTO `deliver_choice` (`id`, `deliver_choice_name`, `created_at`, `updated_at`) VALUES
(1, 'ส่งภายในจังหวัด', NULL, NULL),
(2, 'ส่งภายนอกจังหวัด', NULL, NULL);
...
CREATE TABLE `deliver_list` (
  ...
  `deliver` bigint(20) UNSIGNED NOT NULL,
  `orp` bigint(20) UNSIGNED NOT NULL,
  `deliver_service` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `deliver_list` (`id`, `seller`, `deliver`, `orp`, `deliver_service`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 4, 1, '2021-09-26 21:41:33', '2021-09-26 21:41:33'),
(6, 1, 3, 4, 1, '2021-09-26 23:17:53', '2021-09-26 23:17:53');
...
INSERT INTO `deliver_service` (`id`, `start`, `stop`, `deliver`, `timefrom`, `timeto`, `active`, `price`, `duration`, `image`, `created_at`, `updated_at`) VALUES
(1, 13, 1, 3, '2021-09-30 07:36:00', '2021-09-30 00:36:00', 1, 55.00, 5, '115480730037kxvtfhwuickclsixb1obc5sgstiwuo6dui6j2bmyb2kpzwr3jcnjl5s4jvlri9rrwxyfqlubqnetwcvusyfrliinve6hybyfzq1.jpg_1632717444.jpg', '2021-09-26 21:37:24', '2021-09-26 21:37:24');
...
(38, '2021_09_06_155809_update_status_column', 1),
(39, '2021_09_10_085730_create_product_table', 1),
(40, '2021_09_13_033919_create_deliver_choice_table', 2),
(41, '2021_09_13_034515_create_order_vegetable_table', 3),
(42, '2021_09_13_150803_create_deliver_service_table', 4),
(43, '2021_09_13_152100_create_status_deliver_table', 4),
(44, '2021_09_14_155502_create_deliver_list_table', 5),
(45, '2021_09_17_001913_create_status_tracking_table', 5),
(46, '2021_09_17_002448_create_tracking_table', 6),
(47, '2021_09_17_005120_add_tracking_to_order_vegetable', 7),
(48, '2021_09_18_004052_add_tracking_to_order_vegetable_table', 8),
(49, '2021_09_27_030314_add_time_to_product', 8);
...
INSERT INTO `order_vegetable` (`id`, `product_id`, `customer_id`, `orp_amount`, `deliver_choice_id`, `timefrom`, `timeto`, `created_at`, `updated_at`, `tracking`) VALUES
(4, 1, 2, 35.00, 2, NULL, NULL, '2021-09-26 21:26:08', '2021-09-26 21:49:11', 1);
...
CREATE TABLE `product` (
  ...
  `deliver_in` double(8,2) NOT NULL,
  `deliver_out` double(8,2) NOT NULL,
  `amount` int(11) NOT NULL,
  `province_from` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `available_time` double(8,2) NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `timefrom` datetime DEFAULT NULL,
...
INSERT INTO `product` (`id`, `user_id`, `product_name`, `measure`, `product_price`, `deliver_in`, `deliver_out`, `amount`, `province_from`, `available_time`, `image`, `created_at`, `updated_at`, `timefrom`, `timeto`) VALUES
(1, 1, 'Cucumber', 1.00, 35.50, 35.50, 65.50, 350, 'Chanthaburi', 3.00, 'ShotType1_540x540.jpg_1632716689.jpg', '2021-09-26 21:24:49', '2021-09-26 21:24:49', '2021-09-27 11:24:00', '2021-10-04 11:24:00');
...
INSERT INTO `province` (`id`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
--
-- Table structure for table `status_deliver`
--
...
--
-- Dumping data for table `status_deliver`
--

INSERT INTO `status_deliver` (`id`, `status_name`, `created_at`, `updated_at`) VALUES
(1, 'Free', NULL, NULL),
(2, 'Busy', NULL, NULL);
...
INSERT INTO `status_tracking` (`id`, `process_name`, `created_at`, `updated_at`) VALUES
(1, 'กำลังเตรียมสินค้า', NULL, NULL),
(2, 'กำลังจัดส่ง', NULL, NULL),
(3, 'ถีงลูกค้า', NULL, NULL);
...
CREATE TABLE `tracking` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `orp` bigint(20) UNSIGNED DEFAULT NULL,
  `process_status` bigint(20) UNSIGNED NOT NULL,
  `deliver_list` bigint(20) UNSIGNED DEFAULT NULL,
  `tr_place` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'ยังไม่ได้ส่ง',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tracking` (`id`, `orp`, `process_status`, `deliver_list`, `tr_place`, `created_at`, `updated_at`) VALUES
(1, 4, 3, 1, 'bangkok', '2021-09-26 21:41:34', '2021-09-26 21:49:55'),
(6, 4, 2, 6, 'ยังไม่ได้ส่ง', '2021-09-26 23:17:54', '2021-09-26 23:17:54');
...
CREATE TABLE `users` (
  ...
  `status` enum('seller','customer','deliver','Completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'seller',
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `address`, `status`, `phone`, `fname`, `image`, `lname`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Market001', 'market001@vegetable.estore', NULL, '$2y$10$xlDjwxZUmECIxJuSFS72ZOGZs82DIF/bydOwOwM.vI6.4.oCGLY42', 'Chanthaburi', 'seller', '010499958', 'Makly', 'seller-woman-farm-products-harvest-vector-26568237.jpg_1632716630.jpg', 'Sim', NULL, '2021-09-26 21:23:50', '2021-09-26 21:23:50'),
(2, 'Customer001', 'customer001@vegetable.estore', NULL, '$2y$10$xgw20Qp1eXYNzQzCIFvM3u56n0av3hYkL6oaFvfo6JlbMp/R0AaCO', 'Bangkok', 'customer', '0660018286', 'Makly', '132969547-woman-with-cart-vector-illustration-trolley-full-of-healthy-food-flat-clipart-cartoon-character-groc.jpg_1632716753.jpg', 'Sim', NULL, '2021-09-26 21:25:53', '2021-09-26 21:25:53'),
(3, 'deliver001', 'deliver001@vegetable.estore', NULL, '$2y$10$9BF.BBxjODktV1J5M8dl2.vDKTVxSgcgRu2OXAMwX2vy5fMbJ7n.i', 'chanthaburi', 'deliver', '0660018286', 'Makly', 'fresh-food-delivery-van-cartoon-representing-funny-green-driven-friendly-man-cheering-vegetables-fruit-93400662.jpg_1632716933.jpg', 'Sim', NULL, '2021-09-26 21:28:53', '2021-09-26 21:28:53');
...
--
-- Indexes for table `deliver_choice`
--
ALTER TABLE `deliver_choice`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `deliver_list`
  ...
  ADD KEY `fk_ds` (`deliver_service`),
  ADD KEY `fk_orp` (`orp`),
  ADD KEY `fk_service` (`deliver`);
...
ALTER TABLE `deliver_service`
  ...
  ADD KEY `fk_deliver` (`deliver`),
  ADD KEY `fk_start` (`start`),
  ADD KEY `fk_stop` (`stop`);
...
--
-- Indexes for table `status_deliver`
--
ALTER TABLE `status_deliver`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `tracking`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_deliver_list` (`deliver_list`),
  ADD KEY `fk_process` (`process_status`),
  ADD KEY `fk_order_product` (`orp`);
...
--
-- AUTO_INCREMENT for table `deliver_choice`
--
ALTER TABLE `deliver_choice`
...
--
-- AUTO_INCREMENT for table `status_deliver`
--
ALTER TABLE `status_deliver`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `deliver_list`
--
ALTER TABLE `deliver_list`
  ADD CONSTRAINT `fk_ds` FOREIGN KEY (`deliver_service`) REFERENCES `deliver_service` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_orp` FOREIGN KEY (`orp`) REFERENCES `order_vegetable` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_seller` FOREIGN KEY (`seller`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_service` FOREIGN KEY (`deliver`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `deliver_service`
--
ALTER TABLE `deliver_service`
  ADD CONSTRAINT `fk_active` FOREIGN KEY (`active`) REFERENCES `status_deliver` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_deliver` FOREIGN KEY (`deliver`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_start` FOREIGN KEY (`start`) REFERENCES `province` (`id`),
  ADD CONSTRAINT `fk_stop` FOREIGN KEY (`stop`) REFERENCES `province` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tracking`
  ADD CONSTRAINT `fk_deliver_list` FOREIGN KEY (`deliver_list`) REFERENCES `deliver_list` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_order_product` FOREIGN KEY (`orp`) REFERENCES `order_vegetable` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_process` FOREIGN KEY (`process_status`) REFERENCES `status_tracking` (`id`) ON DELETE CASCADE;
COMMIT;
